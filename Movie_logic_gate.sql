...
delete from sandalwood where m_name='Kantara' or m_id=5;
select * from sandalwood where actor_name='Yash' or m_id>2;
delete from sandalwood where language="Hindi" or rating<6;
select *from sandalwood where duration>'02:25:00' or M_id=304;

delete from mollywood where m_name='ARM' and m_id=5;
select * from mollywood where actor_name='Tovino Thomas' and m_id=103;
delete from mollywood where language="Kannada" and rating<6;
select *from mollywood where duration>'02:00:00' and budget>5000000;

delete from tollywood where not m_id>302;
select * from tollywood where m_name='Sita Ramam';
delete from tollywood where not budget<4000000 ;
select *from tollywood where not duration<'02:00:00';